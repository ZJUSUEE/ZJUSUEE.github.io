...
-   :ocean:{ .lg .middle } __工程流体力学（甲）I&II__
    ...
    ![Image title](./courses/public/fundamental/工程流体力学（甲）/starrynight.jpg){ width="120" }
    /// caption
...
-   :simple-steam:{ .lg .middle } __工程热力学（甲）__
    ...
    ![Image title](./courses/public/professional/工程热力学（甲）/thermodynamics.jpg){ width="120" }
    /// caption
...
-   :fire:{ .lg .middle } __传热学（甲）__
    ...
    ![Image title](./courses/public/professional/传热学（甲）/heattransfer.jpg){ width="120" }
    /// caption
