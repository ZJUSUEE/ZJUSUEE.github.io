...
=== "陈可欣"
    ...
    <div class="pdf-container">
    <object data="常微分总结ckx.pdf" type="application/pdf" aria-labelledby="PDF document">
        <embed src="常微分总结ckx.pdf" type="application/pdf" />
        <p>
            Your browser does not support PDFs
            <a href="常微分总结ckx.pdf" class="image fit">下载笔记</a>
        </p>
    </object>
