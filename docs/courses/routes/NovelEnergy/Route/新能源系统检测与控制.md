...
=== "燕天润"
    ...
    <div class="pdf-container">
    <object data="新能源系统控制与检测by燕天润.pdf" type="application/pdf" aria-labelledby="PDF document">
        <embed src="新能源系统控制与检测by燕天润.pdf" type="application/pdf" />
        <p>
            Your browser does not support PDFs
            <a href="新能源系统控制与检测by燕天润.pdf" class="image fit">下载笔记</a>
        </p>
    </object>
